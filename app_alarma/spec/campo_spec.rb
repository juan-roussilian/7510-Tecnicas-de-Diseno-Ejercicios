...
describe 'Campo' do
  it 'Casa de campo con sensor de movimiento 9 esta asegurado' do
  ...
  it 'Casa de campo con sensor de apertura y camara activos esta comprometido' do
  ...
  it 'Casa de campo con los 3 sensores activos esta comprometido' do
    sensor_apertura = SensorSimple.new(1)
